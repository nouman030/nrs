...
import { Contact, Funnel, Lane, Pipeline, SubAccount, Tag, Ticket as TicketType } from "@prisma/client"
...
export default function SubaccountDashboard({ subaccountDetails }: SubaccountDashboardProps) {
