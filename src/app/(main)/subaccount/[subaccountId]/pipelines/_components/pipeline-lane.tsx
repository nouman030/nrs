...
import { deleteLane, seveActivityLogsNotification } from '@/lib/queries'
...
const PipelineLane: React.FC<PipelaneLaneProps> = ({
  ...
  return (
    <Draggable draggableId={laneDetails.id.toString()} index={index}>
      {(provided, snapshot) => (
        <div
        ...
        >
          <AlertDialog>
            <DropdownMenu>
              <div className="bg-slate-200/30 dark:bg-background/20 h-[600px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0">
                <div
