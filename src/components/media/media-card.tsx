...
import { deleteMedia, seveActivityLogsNotification } from '@/lib/queries'
...
const MediaCard = ({ file }: Props) => {
  ...
  return (
    <AlertDialog>
      <DropdownMenu>
        <article className="border w-full rounded-lg dark:bg-slate-900 bg-gray-950">
          <div className="relative w-full h-40">
            <Image
              src={file.link}
              alt="preview image"
             fill
              className="object-contain rounded-lg items-center object-top"
            />
          </div>
